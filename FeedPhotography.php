	...
	<body>
		...
		<?php
			...
			if(isset($_POST['search'])){
				...
				$sq = " select * from photographer order by address ";
				$searchKey = "";
			}
		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-2"><a href="Profile_Photography.php?id=<?php echo $res['id']; ?>"><button class="btn btn-success">visit</button></a></div>
				</div>
			</div>
