					...
					<div class="col-8">
						<div class="main-form">
							<div class="form-group">
								<label>Name</label>
								<input type="text" name="name" class="form-control" placeholder="Name" value="" style="margin-right: 10vw;"  autocomplete="off" required >
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input type="text" name="availibility" class="form-control" placeholder="Availibility" value="" style="margin-right: 10vw;"  autocomplete="off" required >
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<textarea name="extra_facilities" class="form-control" autocomplete="off" required ></textarea>
							</div>
							<div class="form-group">
								<input type="text" name="avg_exp" class="form-control" placeholder="Average Expenditure" value="" style="margin-right: 10vw;"  autocomplete="off" required >
							</div>
